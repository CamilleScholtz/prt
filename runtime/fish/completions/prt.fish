...
complete -c prt -n '__fish_seen_subcommand_from diff' -o n -l no-alias -d 'disable aliasing'
complete -c prt -n '__fish_seen_subcommand_from diff' -o v -l version -d 'list with version info'
...
complete -c prt -n '__fish_seen_subcommand_from list' -o i -l installed -d 'list installed ports only'
complete -c prt -n '__fish_seen_subcommand_from list' -o r -l repo -d 'list with repo info'
complete -c prt -n '__fish_seen_subcommand_from list' -o b -l version -d 'list with version info'
complete -c prt -n '__fish_seen_subcommand_from list' -o h -l help -d 'print help and exit'

complete -c prt -n '__fish_use_subcommand' -a loc -d 'prints port locations'
complete -c prt -n '__fish_seen_subcommand_from loc' -x -a "(prt list)"
complete -c prt -n '__fish_seen_subcommand_from loc' -o d -l duplicate -d 'list duplicate ports as well'
complete -c prt -n '__fish_seen_subcommand_from loc' -o n -l no-alias -d 'disable aliasing'
complete -c prt -n '__fish_seen_subcommand_from loc' -o h -l help -d 'print help and exit'
...
complete -c prt -n '__fish_use_subcommand' -a prov -d 'search ports for files'
complete -c prt -n '__fish_seen_subcommand_from prov' -o i -l installed -d 'search in installed ports only'
complete -c prt -n '__fish_seen_subcommand_from prov' -o h -l help -d 'print help and exit'
